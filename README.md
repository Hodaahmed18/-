...
|---------|-------------|------|
| SussedOut | AI-powered scam detection tool, live at sussedout.co.uk | [View →](https://github.com/Hodaahmed18/sussedout) |
...
![CI/CD](https://img.shields.io/badge/CI%2FCD-Jenkins%20%7C%20GitHub%20Actions-black?style=flat-square&logo=jenkins)

---

## 📈 Currently Learning
- Splunk for log analysis and monitoring
- Kubernetes and container orchestration (CKA prep)
